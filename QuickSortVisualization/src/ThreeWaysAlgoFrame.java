...
public class ThreeWaysAlgoFrame extends JFrame{

    private int canvasWidth;
    private int canvasHeight;

    public ThreeWaysAlgoFrame(String title, int canvasWidth, int canvasHeight){
    ...
    public ThreeWaysAlgoFrame(String title){
